package controller;
/**
 * Supplied controller ModifyProductController.java
 */
...
public class ModifyProductController implements Initializable {
     ...
     * @return true
     */
    public boolean onSearchPartBtn() {
    ...
    /**
     * @param product sendProduct
     * takes selected product and populates the individual attributes in the modify product screen text fields.
     * In addition, will add saved associated parts*/
    public void sendProduct(Product product) {
        NewProd = product;
        prodID.setText(String.valueOf(NewProd.getId()));
        prodName.setText(String.valueOf(NewProd.getName()));
        prodInv.setText(String.valueOf(NewProd.getStock()));
        prodPrice.setText(String.valueOf(NewProd.getPrice()));
        prodMax.setText(String.valueOf(NewProd.getMax()));
        prodMin.setText(String.valueOf(NewProd.getMin()));
